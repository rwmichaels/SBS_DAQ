...
#define BobpartGetItem(p,i) {BoblistGet(&(p->list),i);}
...
#ifdef EVENT_MODE
      /* printf("rol input %d %d \n",rol->input,input_event__); */
      BobpartGetItem(rol->input,input_event__); 
      /* printf("(XXX) input_event again %d \n",input_event__); */
